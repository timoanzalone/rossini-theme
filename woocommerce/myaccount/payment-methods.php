...
<?php if ( $has_methods ) : ?>
	...
	echo '<a style="vertical-align: middle;" href="' . esc_url( $action['url'] ) . '" class="btn btn-primary text-decoration-underline' . sanitize_html_class( $key ) . '">' . esc_html( $action['name'] ) . '</a>&nbsp;';
	}
	}
	?>
	</td>
