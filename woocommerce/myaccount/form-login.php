...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="row pt-3" id="customer_login">
	...
	<form class="form-group woocommerce-form woocommerce-form-login login" method="post">
	...
	<button type="submit" class="btn btn-primary mr-2" name="login" value="<?php esc_attr_e( 'Log in', 'understrap' ); ?>"><?php esc_html_e( 'Log in', 'understrap' ); ?></button>
	...
	<a class="mr-3" href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Lost your password?', 'understrap' ); ?></a>
	<a href="#"><?php esc_html_e( 'Register', 'understrap' ); ?></a>
	</p>
	...
	<form method="post" class="form-group woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
	...
	<button type="submit" class="btn btn-primary" name="register" value="<?php esc_attr_e( 'Register', 'understrap' ); ?>"><?php esc_html_e( 'Register', 'understrap' ); ?></button>
	</p>
