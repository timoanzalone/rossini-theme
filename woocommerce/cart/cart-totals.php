...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<div cellspacing="0" class="shop_table shop_table_responsive">
		...
		<div class="cart-subtotal text-center">
			...
			<div class="text-center cart-discount coupon-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
		...
		<div class="order-total text-center">
			<span style="vertical-align: middle;"><?php _e( 'Total', 'woocommerce' ); ?></span>
			<h2 style="display: inline; vertical-align: middle;" data-title="<?php esc_attr_e( 'Total', 'woocommerce' ); ?>"><?php wc_cart_totals_order_total_html(); ?></h2>
		</div>
